...
# Commented out cause test was made on standard dialogpt while now it uses custom one 
# TODO: put pytorch model to test compl 
...
#         o = model.run(None, {'input_ids': ids, 'token_type_ids': ""})
#         logits = o[0][:, -1, :]
#         if i < min_length:
#             logits[:, -1] = -float("inf")
