...
setup(
    ...
    entry_points="""
    [console_scripts]
    chatbot_server=chatbot_server.cli:cli
    """,
    ...
    url= 'https://github.com/eublefar/chatbot_server',
    download_url=(
        f'https://github.com/eublefar/'
        f'chatbot_server/archive/{version}.tar.gz'
    ),
    keywords=[
